...
> **Status: Pre-alpha.** Content Core through Plugin Extensibility (Phase 5.1) and Block Registration (Phase 5.2) are implemented; Phase 6 Integrations is next.
...
| Integrations core (Phase 6+) | Planned |
