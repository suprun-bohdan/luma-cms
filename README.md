...
> **Status: Pre-alpha.** Content Core through Visual Editing (Phase 4.3) and Plugin Extensibility (Phase 5.1) are implemented; block type registration (Phase 5.2) is next.
...
| Block type registration (Phase 5.2+) | Planned |
