...
> **Status: Pre-alpha `[0.0.25-rc.2]`.** Content Core through Integrations (Phase 6), production installer (Phase 7), web setup / onboarding / shared-hosting updates (Phase 8), and install rehearsal (Phase 8.4) are implemented.
